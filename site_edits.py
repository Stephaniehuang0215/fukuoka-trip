...
DAY3_BOATS = """<div style="padding:var(--space-4);border-radius:calc(var(--radius-lg)*1.15);background:var(--color-surface);margin-bottom:var(--space-4);">
        ...
        <ul style="margin:0;padding-left:1.1em;font-size:13px;opacity:0.85;line-height:1.75;">
          <li style="margin-bottom:6px;"><b><a href="https://www.yanagawakk.co.jp/" target="_blank" rel="noopener" style="color:var(--color-accent-700);text-decoration:underline;text-underline-offset:3px;">柳川觀光開發</a></b>：柳川歷史最悠久的遊船公司，也是太宰府・柳川暢遊套票合作船家，想體驗正統柳川遊船文化首選。</li>
          <li style="margin-bottom:6px;"><b><a href="https://hakusyukankou.com/" target="_blank" rel="noopener" style="color:var(--color-accent-700);text-decoration:underline;text-underline-offset:3px;">伯舟觀光</a></b>：船夫多是帥氣年輕人，有精彩「跳船表演」，深受女性朋友歡迎，能在 Klook 預約非常方便。</li>
          <li><b><a href="https://kawakudari.com/" target="_blank" rel="noopener" style="color:var(--color-accent-700);text-decoration:underline;text-underline-offset:3px;">水鄉柳川觀光</a></b>：除了通常川下路線外，平時也有「下百町↔並倉」U-turn 巡遊，能搭乘 60 分鐘又返回原點，省去搭接駁車麻煩，可於 KKday 預約很方便。</li>
        </ul>
      </div>
