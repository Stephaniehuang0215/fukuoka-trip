...
DAY3_UNAGI_SHOPS = """
        ...
        <ul style="margin:var(--space-2) 0 0;padding-left:1.1em;font-size:13px;opacity:0.85;line-height:1.75;">
          <li style="margin-bottom:6px;"><b>元祖本吉屋 本店</b>：福岡縣柳川市旭町69番地　10:30–19:00　公休：每週一<br><b>預約</b>：可電話預約（0944-72-6155，受理 10:30–21:00），<b>週六日不接受預約</b>，只能現場依序排隊。　<a href="https://maps.app.goo.gl/EVdKosKaBxMJVqYX9" target="_blank" rel="noopener" style="%s">Google 地圖 →</a></li>
